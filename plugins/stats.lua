...
local function run(msg, matches)
  if matches[1]:lower() == 'inthedarkness' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "inthedarkness" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (inthedarkness)",-- Put everything you like :)
		"^([Ii]inthedarkness)"-- Put everything you like :)
    }, 
  run = run
}
