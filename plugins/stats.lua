...
local function run(msg, matches)
  if matches[1]:lower() == 'darkness' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "darkness" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (darkness)",-- Put everything you like :)
		"^([Dd]arkness)"-- Put everything you like :)
    }, 
  run = run
}
